...
#ifdef __cplusplus
extern "C" {
	extern void progressStart(int yPos);
	extern void progressDraw(u32 pos,u32 max);
...
#define FAT_fread_fast FAT_fread
...
extern bool FAT_GetLongFilenameUnicode (Tunicode* filename);
